...
class SearchDetailAdapter(private val itemList : ArrayList<search>) :
    ...
    class ViewHolder(itemView: View) :
        ...
        var menuList: TextView = itemView.findViewById(R.id.txt_menu)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent?.context).inflate(R.layout.item_search_main_list, parent, false)
